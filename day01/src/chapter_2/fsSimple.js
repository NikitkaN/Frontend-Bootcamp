...
readAndWriteCallbackHell('files/fsSimple/file1.txt', 'files/fsSimple/file2.txt'); // 1
// readAndWritePromises('files/fsSimple/file1.txt', 'files/fsSimple/file2.txt'); // 2
// readAndWriteAsyncAwait('files/fsSimple/file1.txt', 'files/fsSimple/file2.txt'); // 3